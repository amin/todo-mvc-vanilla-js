...
export class Todo {
    ...
    bindEvents = () => {
        todoFactory.on('input[name="checkbox"]', 'click', ((e) => console.log(e.currentTarget)))
        todoFactory.on('input[name="task"]', 'click', ((e) => console.log(e.currentTarget)))
        todoFactory.on('input[name="destroy"]', 'click', ((e) => console.log(e.currentTarget)))
    }
